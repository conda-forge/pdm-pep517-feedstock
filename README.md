...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdm-pep517-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13976&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdm-pep517-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdm-pep517` can be installed with:

```
conda install pdm-pep517
```

It is possible to list all of the versions of `pdm-pep517` available on your platform with:
